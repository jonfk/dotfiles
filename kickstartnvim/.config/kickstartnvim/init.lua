...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch All [F]iles (incl. hid/ignd)' })
...

  {
    ...
    config = function()
      ...
      vim.notify(string.format('selected colorscheme: %s', random_scheme), vim.log.levels.INFO)
    end,
  },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- TODO:
      -- Add mapping for <leader>e and E when in mini.files buffer to close it
      -- Add mapping for mapping <esc><esc> to close mini.files like q
